...
export default function OffertCard() {
  return (
    <div className="h-[10rem] w-[30rem] sm:w-[23rem] sm:h-[8rem] rounded-sm bg-main-text-color  flex flex-col gap-3 hover:scale-[1.02] transition duration-300 cursor-pointer shadow-xl">

...
export default function JobCard() {
  return (
    <div className="h-[15rem] w-[40rem] sm:w-[23rem] sm:h-[20rem] bg-main-text-color py-4 px-4 flex flex-col gap-3 shadow-xl  hover:scale-105 transition duration-300 cursor-pointer">

  ...
  return (
    <div className="h-[40rem] bg-main-background-color flex justify-center items-center gap-5 flex-col sm:h-[45rem]">
      ...
      <div className="flex gap-8 sm:flex-col">
        <div className="bg-main-yellow-color w-[22rem] h-[23rem] sm:w-[18rem] sm:h-[8rem] flex flex-col justify-center items-center cursor-pointer hover:bg-main-text-color group hover:scale-105 transition duration-300 ease-in-out">
